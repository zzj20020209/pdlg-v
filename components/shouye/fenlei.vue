<template>
  <div>
    <el-row style="margin-left: 8px;padding-top: 120px">
  ...
  export default {
    ...
    methods: {
      ...
      getData() { //获取数据方法
        ...
        params.append("gbsid",this.dflid);
        params.append("gssid",this.xflid);
        this.$axios.post("/cx.action",params).
    ...
    created() { //钩子函数  vue对象初始化完成后  执行
      this.dflid=sessionStorage.getItem("dfl")
      this.xflid=sessionStorage.getItem("spxfl")
      this.getData();
      this.load();
    }
  }
